              ...
              <div className="portfolio-item">
                ...
                <div className="portfolio-caption">
                  ...
                  <div className="portfolio-caption-subheading text-muted text-center">
                    <a
                      href="https://github.com/kalkidan1919/portfolio.git"
            ...
            <div className="col-lg-4 col-sm-6 mb-4">
              <div className="portfolio-item">
                ...
                <div className="portfolio-caption">
                  ...
                  <a
                    href="https://github.com/kalkidan1919/Distributed_library_management.git"
                    className="btn btn-warning btn-sm mt-2"
                  >
                    View here
                  </a>
              ...
              <div className="portfolio-item">
                ...
                >
                  ...
                  <img
                    className="img-fluid"
                    src={pic3}
                    alt="Puppy Lovers Page"
                  />
                </a>
                <div className="portfolio-caption">
                  <div className="portfolio-caption-heading">snake-game</div>
                  <a
                    href="https://github.com/kalkidan1919/Snake-game.git"
                    className="btn btn-warning btn-sm mt-2"
                  >
                    View here
                  </a>
